    ...
    <nav class="bg-white shadow">
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                        ...
                        <a href="../courses/index.php" class="<?= strpos($currentPage, 'courses') !== false ? 'border-indigo-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700' ?> inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                            Courses
                        </a>
                        ...
                        <div class="ml-3 relative">
                            ...
                            <div id="user-dropdown" class="hidden origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                                ...
                                <?php if ($userRole === 'teacher'): ?>
                                    <a href="../teacher/courses/index.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">My Courses</a>
                                <?php endif; ?>
        ...
        <div class="sm:hidden hidden" id="mobile-menu">
            <div class="pt-2 pb-3 space-y-1">
                <a href="../index.php" class="<?= $currentPage === 'index.php' ? 'bg-indigo-50 border-indigo-500 text-indigo-700' : 'border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700' ?> block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
                    Home
                </a>
                <a href="../courses/index.php" class="<?= strpos($currentPage, 'courses') !== false ? 'bg-indigo-50 border-indigo-500 text-indigo-700' : 'border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700' ?> block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
                    Courses
                </a>
                <?php if ($isLoggedIn && $userRole === 'teacher'): ?>
                    <a href="../teacher/index.php" class="<?= strpos($_SERVER['REQUEST_URI'], '/teacher') !== false ? 'bg-indigo-50 border-indigo-500 text-indigo-700' : 'border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700' ?> block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
                        Teacher Dashboard
                    </a>
                <?php endif; ?>
                <?php if ($isLoggedIn && $userRole === 'admin'): ?>
                    <a href="../admin/index.php" class="<?= strpos($_SERVER['REQUEST_URI'], '/admin') !== false ? 'bg-indigo-50 border-indigo-500 text-indigo-700' : 'border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700' ?> block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
                        Admin Dashboard
                    </a>
                <?php endif; ?>
            </div>
            <?php if ($isLoggedIn): ?>
                <div class="pt-4 pb-3 border-t border-gray-200">
                    ...
                    <div class="mt-3 space-y-1">
                        ...
                        <?php if ($userRole === 'teacher'): ?>
                            <a href="../teacher/courses/index.php" class="block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100">
                                My Courses
                            </a>
                        <?php endif; ?>
